...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            <h3 class="fw-bold mb-4">Master <span style="color: silver;"></span>Type</h3>
            <div class="card p-2">
                <div class="col-12">
                    ...
                    <table class="table table-hover tab-pane">
                        ...
                        @foreach ($items as $key => $item)
                            <tr class="removeble-tr-{{ $item->id }}">
                                ...
                                <td>
                                    <input type="text" class="border-0 update-rm" data-id='{{ $item->id }}'
                                        value=" {{ $item->rm }}">
                                </td>
                                <td>
                    ...
                    <div class="card-body pt-10 ">
                        ...
                        <form method="POST" action="{{ route('master.type.create') }}">
                            @csrf

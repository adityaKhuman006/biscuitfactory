            ...
            <div class="col-12 p-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="" id="finishedgoodMaterialCreateOut" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        $('#finishedgoodMaterialCreateOut').on('submit', function(event) {
            ...
            $.ajax({
                url: '/finishedgood-material-create-out',
                data: formData,
                type: 'post',
                contentType: false,
                processData: false,
                ...
                success: function(data) {
                    $('#finishedgoodMaterialCreateOut')[0].reset();
                },

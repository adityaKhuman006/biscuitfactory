    ...
    <div class="row">
      ...
      <div data-repeater-list="category-group mt-5">
        ...
        <div class="form-group">
          ...
          class="form-control form-control-sm border-black" placeholder="Item Name">
          </div>
        </div>
        </div>
        <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="number" name="recipie_weight" value="{{ $material->recipie_weight }}"
                      ...
                      <div class="row" data-repeater-item>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <div class="form-group">
                              <label>UDM</label>
                              <input type="text" name="umd" required class="form-control form-control-sm border-black"
                                placeholder="UDM">
                            </div>
                          </div>
                        </div>

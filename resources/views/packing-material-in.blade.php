            ...
            <div class="col-12 p-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="" id="dataPackingAdd" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        $('#dataPackingAdd').on('submit', function(event) {

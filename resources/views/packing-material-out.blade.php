            ...
            <div class="col-12 p-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="" id="PackingMaterialCreateOut" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        $('#PackingMaterialCreateOut').on('submit', function(event) {
            ...
            $.ajax({
                url: '/Packing-material-create-out',
                data: formData,
                type: 'post',
                contentType: false,
                processData: false,
                ...
                success: function(data) {
                    $('#PackingMaterialCreateOut')[0].reset();
                },
